...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-sm navbar-light">
        <div class="container">
            <a class="navbar-brand" href="index.html"><i class='uil uil-user'></i> Abdelhamid</a>
                        ...
                        <h1 class="animated animated-text">
                            <span class="mr-2">Hey folks, I'm</span>
                                <div class="animated-info" >
                                    <span class="animated-item" >Abdelhamid ELBADRI</span>
                                    <span class="animated-item">Software Engineer</span>
                                    <span class="animated-item">web and mobile developer</span>
                                </div>
                        </h1>

                        <p>• I am a 5th year Software engineering student able to build a wide range of software (mobile & desktop apps, game engines, games) from the ground up - from conceiving, designing an architecture, to programming and deploying. Skilled at writing well-designed, testable and efficient code using current best practices in software engineering, and what I learned from design patterns and algorithms. Fast learner, hard worker, motivated and team player who is proficient in an array of programming and scripting languages such as C/C++, Java, Python, C#...</p>
                        <p>•Entering the university was an opportunity to extended my knowledge mainly in computer architecture, algorithms and theoretical computer science in general. I have been always interested in other areas of computer science, as well, like cybersecurity, cryptography, artificial intelligence and virtual reality.</p>
                        <p>•I am thorough, a hard worker and I enjoy working with a team</p>
                        
                        <div class="custom-btn-group mt-4">
                        
                          <a href="https://drive.google.com/uc?id=1aU159A7oT3rE2uiZkjz-4A6AfxoQ3pbs&export=download" class="btn mr-lg-2 custom-btn"><i class='uil uil-file-alt'></i> Download Resume</a>
                          <a href="https://www.linkedin.com/in/abdelhamid-elbadri-19366314a/" class="btn custom-btn custom-btn-bg custom-btn-link">Get in touch</a>
                        </div>
                    </div>
                </div>
